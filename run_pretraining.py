...
parser.add_argument("--bert_config_file", type=str, required=True, help="The config json file corresponding to the pre_trained BERT model. "
    "This specifies the model architecture.")
parser.add_argument("--input_file", type=str, required=True, help="Input TF example files (can be a glob or comma separated).")
...
parser.add_argument("--init_checkpoint", type=str, help="Initial checkpoint (usually from a pre_trained BERT model).")
...
parser.add_argument("--save_checkpoints_steps", default=1000, type=int, help=
                     "How often to save the model checkpoint.")
parser.add_argument("--iterations_per_loop", default=1000, type=int, help=
...
setattr(FLAGS, 'tpu_name', None)
setattr(FLAGS, 'master', None)
setattr(FLAGS, 'gcp_project', None)
setattr(FLAGS, 'num_tpu_cores', 8)
